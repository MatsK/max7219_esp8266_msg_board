...
#include <stdio.h>
#include <ArduinoJson.h>   // by Benoit Blanchon, ver 6.21.5 (Not compatible with v7.x)
...
void setup() {
  ...
  //wm.setSTAStaticIPConfig(IPAddress(192,168,1,92), IPAddress(192,168,1,1), IPAddress(255,255,255,0), IPAddress(192,168,1,1));
