...
#define CS_PIN        D6  // CS_PIN D8 for NodeMCU 1.0 (ESP12E-Module)

#define BUZZER        D1  // Define pin for a buzzer

#define FLASH_BUTTON  D2  // Button for restoring default settings

#define VERSION         "v2025.04.11"

// Select one of the below MAX7219 hardware types:
//   - PAROLA_HW
//   - GENERIC_HW
//   - ICSTATION_HW
//   - FC16_HW
